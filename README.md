...
- `logging_config.py` — единый конфиг логирования (консоль + ротация файлов)
...
Текущие задачи:
1) вернуть обработку медикаментов (приведение к стандартным ед измерения там где это возможно + дополнительные обработчики ошибок)
2) в reason_checking нужно записывать все не корректности которые были найдены
3) значения по умолчанию
4) Отсутствие дополнительной информации о членах семьи
